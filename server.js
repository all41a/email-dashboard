...
const { db, uid, seedIfEmpty, detectActionRequired, detectCategory, refreshCategoryCounts } = require('./db');
...
// Bulk actions: { ids: [...], action: 'archive'|'delete'|'read'|'unread'|'spam'|'categorize'|'vip', category? }
